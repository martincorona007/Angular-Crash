...
export class HeroService {
  ...
  */
  ...
  getHeroes(): Observable<Hero[]>{
    return this.http.get<Hero []>(this.heroesUrl).pipe(tap(_ => this.log('fecthed heroes')), catchError(this.handleError<Hero[]>('getHeroes',[])));
  }
  ...
  addHero(hero: Hero): Observable<Hero>{
    return this.http.post<Hero>(this.heroesUrl,hero,this.httpOptions).pipe(tap((newHero: Hero) => this.log(`added hero w/ id=${newHero.id}`)),this.handleError<Hero>('addHero'));
  }
